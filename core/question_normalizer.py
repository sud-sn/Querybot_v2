...
_LEXICON: dict[str, str] = {
    ...
    "mediane": "median",
    "somme": "sum",
    # ── Commanding the result card ──────────────────────────────────────────
    # core/result_commands.py reads English: sort, exclude/remove, keep the
    # top N, show as a chart, undo. A French reader's command is canonicalised
    # before it reaches the parser, and the lexicon carried no verb the parser
    # knows -- "trie par montant" arrived as "trie by amount" and fell through
    # to "I could not answer that". English readers had a card they could
    # command; French readers had one they could only look at.
    #
    # Bare "classe" is not here (a product class), nor "annule" on its own (a
    # cancelled status, already below), nor the plural "croissants" (a
    # bakery's product). Each undo phrase is a whole phrase for the same
    # reason: "annule" must keep meaning cancelled.
    "trie": "sort",
    "trier": "sort",
    "triez": "sort",
    "trie-les": "sort",
    ...
    "décroissante": "descending",
    "décroissants": "descending",
    "décroissantes": "descending",
    "croissant": "ascending",
    "croissante": "ascending",
    "du plus grand au plus petit": "descending",
    "du plus élevé au plus faible": "descending",
    "du plus petit au plus grand": "ascending",
    "du plus faible au plus élevé": "ascending",
    "exclus": "exclude",
    "exclure": "exclude",
    "excluez": "exclude",
    "exclue": "exclude",
    ...
    "ôter": "remove",
    "ôtez": "remove",
    "de ce résultat": "from this result",
    "de ces résultats": "from these results",
    "de cette liste": "from this list",
    "du résultat": "from the result",
    "de la liste": "from the list",
    "garde": "keep",
    "garder": "keep",
    "gardez": "keep",
    "conserve": "keep",
    "conserver": "keep",
    "conservez": "keep",
    "ne garde que": "keep only",
    "ne gardez que": "keep only",
    "ne conserve que": "keep only",
    "seulement": "only",
    "uniquement": "only",
    "graphique": "chart",
    "graphe": "chart",
    "camembert": "pie chart",
    "en camembert": "as a pie chart",
    "en secteurs": "as a pie chart",
    "en barres": "as a bar chart",
    "en bâtons": "as a bar chart",
    "en histogramme": "as a bar chart",
    "en courbe": "as a line chart",
    "en courbes": "as a line chart",
    "en tableau": "as a table",
    "en aires": "as an area chart",
    "en anneau": "as a donut chart",
    "en nuage de points": "as a scatter chart",
    # "ligne" is "row" below; inside "en ligne" it is neither, and "la ligne
    # 2" has to reach the parser as "row 2", which is the shape it reads.
    "en ligne": "online",
    "la ligne": "row",
    "annule la dernière modification": "undo last change",
    "annuler la dernière modification": "undo last change",
    "annulez la dernière modification": "undo last change",
    "annule le dernier changement": "undo last change",
    "annuler le dernier changement": "undo last change",
    "reviens en arrière": "go back",
